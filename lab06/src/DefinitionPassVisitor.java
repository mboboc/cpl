public class DefinitionPassVisitor implements ASTVisitor<Void> {
    ...
    public Void visit(VarDef varDef) {
        ...
        if (type.getToken().getText().equals("Int"))
            symbol.setType(TypeSymbol.INT);
        else if (type.getToken().getText().equals("Float"))
            symbol.setType(TypeSymbol.FLOAT);
        else if (type.getToken().getText().equals("Bool"))
            symbol.setType(TypeSymbol.BOOL);
        else
            ASTVisitor.error(id.getToken(),
                    id.getToken().getText() + " type doesn't exist");
    ...
    public Void visit(FuncDef funcDef) {
        ...
        if (type.getToken().getText().equals("Int"))
            ...
            functionSymbol.setType(TypeSymbol.FLOAT);
        else if (type.getToken().getText().equals("Bool"))
            functionSymbol.setType(TypeSymbol.BOOL);
        else
            ASTVisitor.error(id.getToken(),
                    id.getToken().getText() + " return type doesn't exist");
    ...
    public Void visit(Formal formal) {
        ...
        if (type.getToken().getText().equals("Int"))
            ...
            ASTVisitor.error(id.getToken(),
                    id.getToken().getText() + " formal type doesn't exist");
