...
expr
    ...
    |  	ID LPAREN expr (COMMA expr)* RPAREN							# func 
    | 	expr (LT | LE) expr 										# comparison
...
t3
	: LPAREN t3 RPAREN 											# t3_paren
	| left_mult = t3 MULT right_mul = t3 						# mult_op
	| left_div  = t3 DIV right_div = t3  						# div_op
	| left_plus = t3 PLUS right_plus = t3 						# plus_op
	| left_minus = t3 MINUS right_minus = t3					# minus_op
	| INT 														# t3_int				
	;
